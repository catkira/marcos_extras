...
if [[ "$#" -ne 2 || ($2 != "rp-125" && $2 != "rp-122" ) ]]; then
    ...
    echo "Example usage: "
    echo "   ./marcos_setup_bm.sh 192.168.1.163 rp-122"
    exit
fi
...
git clone --depth=1 -b vn/scratch https://github.com/vnegnev/marcos_server.git /tmp/marcos_server
